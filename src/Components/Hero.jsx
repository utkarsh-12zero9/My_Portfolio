...
const Hero = () => {
    ...
    return (
        <section
            id="home"
            className="min-h-screen bg-[#0A0A0A] flex flex-col-reverse md:flex-row items-center justify-center relative overflow-hidden px-4 sm:px-8"
        >
            {/* Text Section */}
            <motion.div
                className="w-full md:w-[55%] md:pl-16 z-10 flex flex-col items-center md:items-start text-center md:text-left"
            ...
            >
                ...
                <motion.a
                    href="#projects"
                    className="inline-block mt-6 px-4 xs:px-6 py-2 xs:py-3 bg-[#00D4B4] text-[#000000] font-['Inter'] text-lg font-extrabold xs:text-lg transform skew-x-6 hover:bg-[#7B3FE4] hover:text-white transition-colors duration-400 rounded"
            ...
            >
                ...
                <div className="absolute top-0 left-1/2 w-12 h-12 md:w-16 md:h-16 animate-spin-slow">
                    <svg viewBox="0 0 24 24" className="text-[#7B3FE4] w-full h-full">
                        <path fill="currentColor" d="M12 2.7L2.7 12l9.3 9.3 9.3-9.3L12 2.7z" />
                    </svg>
                </div>
            </motion.div>
