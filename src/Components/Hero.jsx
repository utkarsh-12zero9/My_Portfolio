            ...
            <div className="container mx-auto px-8 md:px-16 lg:px-24 relative z-10 grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    <div className="relative w-full aspect-square max-w-[500px] mx-auto">
                        ...
                        {/* Floating Badge — MERN (right, ~2 o'clock) */}
                        <motion.div
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <div className="text-xs text-gray-200">Stack</div>
                                    <div className="font-bold text-sm">MERN</div>
                                </div>
                            </div>
                        </motion.div>

                        {/* Floating Badge — DSA (bottom-center, ~6 o'clock) */}
                        <motion.div
                            className="absolute -left-4 top-[18%] glass-panel p-4 rounded-2xl"
                            animate={{ y: [0, -10, 0] }}
                            transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 1.3 }}
                        >
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-[#7B3FE4]/30 flex items-center justify-center text-[#A78BFA]">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
                                </div>
                                <div>
                                    <div className="text-xs text-gray-200">Problem Solving</div>
                                    <div className="font-bold text-sm">DSA</div>
                                </div>
                            </div>
                        </motion.div>

                        {/* Floating Badge — AI & ML (upper-left, ~10 o'clock) */}
                        <motion.div
                            className="absolute bottom-[2%] left-1/2 -translate-x-1/2 glass-panel p-4 rounded-2xl"
                            animate={{ y: [0, -10, 0] }}
                            transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 2.6 }}
                        >
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-[#F59E0B]/30 flex items-center justify-center text-[#FCD34D]">
